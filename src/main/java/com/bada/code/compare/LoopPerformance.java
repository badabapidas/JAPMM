...
/**
 * Comparison between traditional loop and stream apis, tradition loop is better
 * compare to streams. But if you use parallel stream then that is the best
 * choice. But you have to be careful about your hardware resources
 * 
 * @author bada
 *
 */
