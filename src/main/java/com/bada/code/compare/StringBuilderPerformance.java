...
/**
 * Comparison between String builder and string concatenation Output: String
 * builder is better. But if you add all the concatenation in a single line then
 * JVM is smart enugh to make that string builder internally
 * 
 * @author bada
 *
 */
